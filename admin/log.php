<?php
	...
	if(isset($_POST['btnDeleteLog'])){
		$delLogQry = "DELETE FROM tb_log WHERE idlog in (".implode($_POST['checkboxLog'], ',').")";
	...
	$logPerPages = "";
	$logPerPages = "SELECT count(action) as countAction FROM tb_log";
	...
	<div class="col s12">
		<form action="#" method="post" enctype="multipart/form-data">
			...
			<table class="striped responsive-table">
				...
				<tbody>
					<?php
						if($resultLogQry = mysqli_query($conn, "SELECT *, DATE_FORMAT(date,'%e %b %Y - %H:%i:%s') as dateFormated FROM tb_log ORDER BY date DESC LIMIT ".$perPages." OFFSET ".$start."")){
